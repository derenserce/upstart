...
export const Navbar = () => {
  return (
    <nav className="pb-safe-bottom mb-2 fixed bottom-0 left-0 right-0 z-50 flex h-14 w-full items-center justify-around border-t border-white bg-background shadow-[0_-2px_4px_rgba(0,0,0,0.1)] md:h-16">
      <Link
        href="/"
